...
* The data containing countries' GDP from 1960 to 2015 can be found at the [World Bank](http://data.worldbank.org/indicator/NY.GDP.MKTP.CD) and is stored in the csv file `world_bank.csv`, and then read into the DataFrame **GDP**. 
