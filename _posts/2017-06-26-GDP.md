...
# Analyzing Energy indicators of nations in context of their GDP
## [Aashita Kesarwani](http://www.aashitak.com/about/)

This is part of an assignment for the the online course [Introduction to Data Science in Python](https://www.coursera.org/learn/python-data-analysis). The following data files are used, provided with the links to the sources:

* The energy data from the excel file `Energy Indicators.xls`, which is a list of indicators of [energy supply and renewable electricity production](Energy%20Indicators.xls) from the [United Nations](http://unstats.un.org/unsd/environment/excel_file_tables/2013/Energy%20Indicators.xls) for the year 2013 is read into a DataFrame with the variable name of **energy**. 
* The GDP data from the csv file `world_bank.csv`, containing countries' GDP from 1960 to 2015 from [World Bank](http://data.worldbank.org/indicator/NY.GDP.MKTP.CD) is read into the DataFrame **GDP**. 

* The data [Sciamgo Journal and Country Rank data for Energy Engineering and Power Technology](http://www.scimagojr.com/countryrank.php?category=2102) from the file `scimagojr-3.xlsx`, which ranks countries based on their journal contributions in the aforementioned area, is loaded into the DataFrame **ScimEn**.
