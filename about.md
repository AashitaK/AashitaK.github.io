...
- A [dataset](https://www.kaggle.com/aashita/nyt-comments), that is currently [among the 20 featured datasets](https://www.kaggle.com/aashita/nyt-comments) on Kaggle, comprised of over 1.2 million comments with 34 variables and over 9,000 articles with 16 variables along with the ideas for data science projects.
...
- [Bag of words models](https://www.kaggle.com/aashita/starter-kernel-for-predicting-nyt-s-pick/log) to predict the probability that a certain comment will be selected as a NYT's pick. 
